...
local ClientGuiEvent = java.import("ClientGuiEvent")
local ClientTickEvent = java.import("ClientTickEvent")

local renderText -- The text to be shared between the render event and tick event

ClientGuiEvent.RENDER_HUD:register(script, function(matrices, tickDelta)
...
ClientTickEvent.CLIENT_PRE:register(script, function(client)
